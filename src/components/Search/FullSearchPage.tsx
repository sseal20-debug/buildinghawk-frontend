...
export function FullSearchPage({ onNavigateToProperty, onClose }: FullSearchPageProps) {
  // Filter state
  ...
  const buildCriteria = useCallback((): BuildingSearchCriteria => {
    ...
    if (ownerName) criteria.owner_name = ownerName
    ...
    return criteria
  }, [selectedCities, minSf, maxSf, status, propertyType, yearBuiltMin, yearBuiltMax, ownerName, clearHeight, dockDoors, glDoors, power, fencedYard, sortBy, sortDir])
    ...
    <div className="full-search-page">
      ...
      <div className="fsp-header">
        ...
        <div className="fsp-result-count">
          {hasSearched && !isSearching && `${resultCount} results`}
      ...
      <div className="fsp-filters">
        {/* Row 1: City, SF Range, Status, Type */}
        ...
        <div className="fsp-filter-row">
          ...
          <div className="fsp-filter-group fsp-filter-wide">
            <label>Owner Name</label>
            <input type="text" placeholder="Search owner..." value={ownerName} onChange={e => setOwnerName(e.target.value)} className="fsp-input" />
          </div>
        </div>

        {/* Row 3: Building Specs */}
        <div className="fsp-filter-row">
          <div className="fsp-filter-group">
        ...
        <div className="fsp-actions">
          ...
          <button className="fsp-btn fsp-btn-secondary" onClick={handleClear}>Clear</button>
        </div>
      </div>
